...
class Restaurant < ApplicationRecord
  ...
  SECTION_OPTIONS = %w[大同區 中正區 中山區 大安區 信義區 萬華區 士林區 瑞芳區 文山區 淡水區 萬里區 北投區]
  CUISINE_OPTIONS = ['中式料理', '日式料理', '亞洲料理', '健康料理', '印度料理', '台灣小吃/台菜', '壽司', '墨西哥料理', '法式料理', '美式料理', '燒肉', '韓式料理', '越南料理', '海鮮料理', '義式料理', '以色列料理', '阿根廷料理']
